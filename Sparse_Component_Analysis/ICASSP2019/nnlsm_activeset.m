...
function [ X,Y,iter,success ] = nnlsm_activeset( A, B, options)
    ...
    if ~isfield(options,'isInputProd')
        options.isInputProd=0;
    end
    isInputProd = options.overwrite; 
