function [A_aux,B_aux,K_aux,err_anls_vec]=     D_nmf_SMP_2(Y,iter,B_0,K_0,D,opts)
%-------------------------------------------------------------------------%
% [A_aux,B_aux,K_aux,err_anls_vec]=     D_nmf_SMP_2(Y,iter,B_0,A_0,D)
%
...
while     (mean(diff_err_filt)>stop_diff &&  t<iter ...
    ...
    %A_aux             =     nnlsHALSupdtv2(Y',B_aux,[],500)';
    end
%     
% 
