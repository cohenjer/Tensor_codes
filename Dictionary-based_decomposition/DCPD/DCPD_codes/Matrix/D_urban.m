...
T         =     A((1+307*0):(307*307),:)'; %Remark : Do not normalize DATA !!
T         =     T/max(T(:));
% Self-dictionnary
D         =     T;
...
% Presentation plots
figure
h=imagesc(reshape(T(10,:),307,307));
...
indice_2D = mod(K_omp,307);
indice_1D = floor(K_omp/307);
